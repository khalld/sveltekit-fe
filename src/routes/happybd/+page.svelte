...
<div class="container mt-4">
    <div class="card mb-2">
        <img src="https://khalld.github.io/sveltekit-fe/imgshbday/1.jpg" class="card-img-top img-fluid" alt="...">
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                Ovviamente, come ben sai senza il sudore non si ottiene nulla, dunque prima di scoprire il messaggio segreto, dovrai risolvere un piccolo indovinello! Non preoccuparti, nulla di serio.<br>
                Sei pronta?
            </p>
        </div>
        ...
        <div class="card-body">
            <a href="{base}/happybd/1" class="card-link">Vai al quiz</a>
        </div>
    </div>
</div>
